console.log('Spotify Clone  Runnning.....');
...
function updateSongList(songList) {
  ...
  Array.from(document.querySelector(".songList").getElementsByTagName("li")).forEach(e => {
    e.querySelector(".playnow img").addEventListener("click", element => {
      let trackName = e.querySelector(".info").firstElementChild.innerHTML.trim();
      
      if (currentSong.src.includes(trackName)) {  
        ...
        // If a new song is clicked, play the new song
        playMusic(trackName); 
        
        // Update all "play now" buttons to play icon
        document.querySelectorAll(".playnow img").forEach(img => img.src = "img/play.svg");
        
        // Set the clicked song's button to pause
        e.querySelector(".playnow img").src = "img/pause.svg";
        }
    });
  });
...
document.querySelector(".nav-search-input").addEventListener("input", (e) => {
